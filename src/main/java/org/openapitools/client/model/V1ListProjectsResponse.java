...
public class V1ListProjectsResponse {
  public static final String SERIALIZED_NAME_PROJECTS = "projects";
  @SerializedName(SERIALIZED_NAME_PROJECTS)
  private List<V1Project> projects = null;
  ...
  public V1ListProjectsResponse projects(List<V1Project> projects) {
    
    this.projects = projects;
    return this;
  }

  public V1ListProjectsResponse addProjectsItem(V1Project projectsItem) {
    if (this.projects == null) {
      this.projects = new ArrayList<V1Project>();
    }
  ...
  **/
  ...
  public List<V1Project> getProjects() {
    return projects;
  }


  public void setProjects(List<V1Project> projects) {
    this.projects = projects;
  }


  public V1ListProjectsResponse nextPage(V1NextPage nextPage) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ListProjectsResponse v1ListProjectsResponse = (V1ListProjectsResponse) o;
    return Objects.equals(this.projects, v1ListProjectsResponse.projects) &&
        Objects.equals(this.nextPage, v1ListProjectsResponse.nextPage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projects, nextPage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1ListProjectsResponse {\n");
