...
public class V1ListProjectsResponse {
  ...
  private List<V1Project> data = null;
  ...
  public V1ListProjectsResponse data(List<V1Project> data) {
    
    this.data = data;
    return this;
  }

  public V1ListProjectsResponse addDataItem(V1Project dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<V1Project>();
    }
  ...
  **/
  ...
  public List<V1Project> getData() {
    return data;
  }


  public void setData(List<V1Project> data) {
    this.data = data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, v1ListProjectsResponse.data) &&
