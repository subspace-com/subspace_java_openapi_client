...
public class V1SipTeleportResponse {
  ...
  public static final String SERIALIZED_NAME_TELEPORT_ENTRY_POINTS = "teleport_entry_points";
  ...
  private V1SipTeleportStatus status = V1SipTeleportStatus.UNKNOWN;
  ...
  **/
  ...
  public V1SipTeleportResponse name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, v1SipTeleportResponse.id) &&
        Objects.equals(this.name, v1SipTeleportResponse.name) &&
        ...
        Objects.equals(this.dateCreated, v1SipTeleportResponse.dateCreated) &&
        Objects.equals(this.dateUpdated, v1SipTeleportResponse.dateUpdated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, destination, teleportEntryPoints, status, dateCreated, dateUpdated);
  }
