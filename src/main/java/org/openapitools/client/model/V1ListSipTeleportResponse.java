...
public class V1ListSipTeleportResponse {
  public static final String SERIALIZED_NAME_SIP_TELEPORTS = "sip_teleports";
  @SerializedName(SERIALIZED_NAME_SIP_TELEPORTS)
  private List<V1SipTeleportResponse> sipTeleports = null;
  ...
  public V1ListSipTeleportResponse sipTeleports(List<V1SipTeleportResponse> sipTeleports) {
    
    this.sipTeleports = sipTeleports;
    return this;
  }

  public V1ListSipTeleportResponse addSipTeleportsItem(V1SipTeleportResponse sipTeleportsItem) {
    if (this.sipTeleports == null) {
      this.sipTeleports = new ArrayList<V1SipTeleportResponse>();
    }
    this.sipTeleports.add(sipTeleportsItem);
    return this;
  }
  ...
  **/
  ...
  public List<V1SipTeleportResponse> getSipTeleports() {
    return sipTeleports;
  }


  public void setSipTeleports(List<V1SipTeleportResponse> sipTeleports) {
    this.sipTeleports = sipTeleports;
  }


  public V1ListSipTeleportResponse nextPage(V1NextPage nextPage) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ListSipTeleportResponse v1ListSipTeleportResponse = (V1ListSipTeleportResponse) o;
    return Objects.equals(this.sipTeleports, v1ListSipTeleportResponse.sipTeleports) &&
        Objects.equals(this.nextPage, v1ListSipTeleportResponse.nextPage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sipTeleports, nextPage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1ListSipTeleportResponse {\n");
    sb.append("    sipTeleports: ").append(toIndentedString(sipTeleports)).append("\n");
