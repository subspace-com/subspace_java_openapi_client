...
public class V1ListSipTeleportResponse {
  ...
  private List<V1SipTeleportResponse> data = null;

  public static final String SERIALIZED_NAME_NEXT_PAGE = "next_page";
  @SerializedName(SERIALIZED_NAME_NEXT_PAGE)
  private V1NextPage nextPage;

  public V1ListSipTeleportResponse() { 
  }

  public V1ListSipTeleportResponse data(List<V1SipTeleportResponse> data) {
    
    this.data = data;
    return this;
  }

  public V1ListSipTeleportResponse addDataItem(V1SipTeleportResponse dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<V1SipTeleportResponse>();
    }
  ...
  **/
  ...
  public List<V1SipTeleportResponse> getData() {
    return data;
  }


  public void setData(List<V1SipTeleportResponse> data) {
    this.data = data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, v1ListSipTeleportResponse.data) &&
