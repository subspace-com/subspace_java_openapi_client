...
public class Body {
  ...
  **/
  ...
  @ApiModelProperty(value = "Optional per plan, Specify the Subspace-returned ingress port")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, destinationIp, destinationPort, subspacePort);
  }
