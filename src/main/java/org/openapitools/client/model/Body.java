...
public class Body {
  ...
  private Integer subspacePort;


  public Body protocol(String protocol) {
   ...
   * @return protocol
  **/
  @ApiModelProperty(required = true, value = "udp or tcp")
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Name of PacketAccelerator")
  ...
  public Body destinationIp(String destinationIp) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Destination IP, e.g. 1.2.3.4")
  ...
  public Body destinationPort(Integer destinationPort) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Destination port, e.g. 443")
  ...
  public Body subspacePort(Integer subspacePort) {
   ...
   /**
   * Desired Subspace-assigned ingress port, optional
   * @return subspacePort
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Desired Subspace-assigned ingress port, optional")

  public Integer getSubspacePort() {
    return subspacePort;
  }


  public void setSubspacePort(Integer subspacePort) {
    this.subspacePort = subspacePort;
  }
  ...
  public boolean equals(Object o) {
    ...
    Body body = (Body) o;
    return Objects.equals(this.protocol, body.protocol) &&
        Objects.equals(this.name, body.name) &&
        Objects.equals(this.destinationIp, body.destinationIp) &&
        Objects.equals(this.destinationPort, body.destinationPort) &&
        Objects.equals(this.subspacePort, body.subspacePort);
  }

  @Override
  public int hashCode() {
    return Objects.hash(protocol, name, destinationIp, destinationPort, subspacePort);
  }
