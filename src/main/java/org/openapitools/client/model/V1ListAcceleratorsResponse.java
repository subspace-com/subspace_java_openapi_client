...
public class V1ListAcceleratorsResponse {
  ...
  public V1ListAcceleratorsResponse accelerators(List<V1Accelerator> accelerators) {
    
    this.accelerators = accelerators;
    return this;
  }

  public V1ListAcceleratorsResponse addAcceleratorsItem(V1Accelerator acceleratorsItem) {
    if (this.accelerators == null) {
      this.accelerators = new ArrayList<V1Accelerator>();
    }
  ...
  **/
  ...
  public List<V1Accelerator> getAccelerators() {
    return accelerators;
  }


  public void setAccelerators(List<V1Accelerator> accelerators) {
    this.accelerators = accelerators;
  }


  public V1ListAcceleratorsResponse nextPage(V1NextPage nextPage) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ListAcceleratorsResponse v1ListAcceleratorsResponse = (V1ListAcceleratorsResponse) o;
    return Objects.equals(this.accelerators, v1ListAcceleratorsResponse.accelerators) &&
        Objects.equals(this.nextPage, v1ListAcceleratorsResponse.nextPage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accelerators, nextPage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1ListAcceleratorsResponse {\n");
