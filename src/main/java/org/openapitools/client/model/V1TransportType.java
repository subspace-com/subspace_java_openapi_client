...
/**
 * Gets or Sets v1TransportType
 */
@JsonAdapter(V1TransportType.Adapter.class)
public enum V1TransportType {
  ...
  public static V1TransportType fromValue(String value) {
    for (V1TransportType b : V1TransportType.values()) {
  ...
  public static class Adapter extends TypeAdapter<V1TransportType> {
    @Override
    public void write(final JsonWriter jsonWriter, final V1TransportType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public V1TransportType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return V1TransportType.fromValue(value);
    }
  }
}
