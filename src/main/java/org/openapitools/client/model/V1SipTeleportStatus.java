...
/**
 * Gets or Sets v1SipTeleportStatus
 */
@JsonAdapter(V1SipTeleportStatus.Adapter.class)
public enum V1SipTeleportStatus {
  ...
  V1SipTeleportStatus(String value) {
    this.value = value;
  }
  ...
  public static V1SipTeleportStatus fromValue(String value) {
    for (V1SipTeleportStatus b : V1SipTeleportStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<V1SipTeleportStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final V1SipTeleportStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public V1SipTeleportStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return V1SipTeleportStatus.fromValue(value);
    }
  }
}
