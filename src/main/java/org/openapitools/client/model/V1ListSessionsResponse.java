...
import org.openapitools.client.model.V1Session;
...
public class V1ListSessionsResponse {
  ...
  public V1ListSessionsResponse sessions(List<V1Session> sessions) {
    
    this.sessions = sessions;
    return this;
  }

  public V1ListSessionsResponse addSessionsItem(V1Session sessionsItem) {
    if (this.sessions == null) {
      this.sessions = new ArrayList<V1Session>();
    }
  ...
  **/
  ...
  public List<V1Session> getSessions() {
    return sessions;
  }


  public void setSessions(List<V1Session> sessions) {
    this.sessions = sessions;
  }


  public V1ListSessionsResponse nextPage(V1NextPage nextPage) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ListSessionsResponse v1ListSessionsResponse = (V1ListSessionsResponse) o;
    return Objects.equals(this.sessions, v1ListSessionsResponse.sessions) &&
        Objects.equals(this.nextPage, v1ListSessionsResponse.nextPage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sessions, nextPage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1ListSessionsResponse {\n");
