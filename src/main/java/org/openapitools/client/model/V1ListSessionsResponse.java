...
public class V1ListSessionsResponse {
  ...
  private List<V1Session> data = null;
  ...
  public V1ListSessionsResponse data(List<V1Session> data) {
    
    this.data = data;
    return this;
  }

  public V1ListSessionsResponse addDataItem(V1Session dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<V1Session>();
    }
  ...
  **/
  ...
  public List<V1Session> getData() {
    return data;
  }


  public void setData(List<V1Session> data) {
    this.data = data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, v1ListSessionsResponse.data) &&
