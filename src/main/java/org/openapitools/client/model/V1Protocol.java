...
/**
 * Gets or Sets v1Protocol
 */
@JsonAdapter(V1Protocol.Adapter.class)
public enum V1Protocol {
  ...
  public static V1Protocol fromValue(String value) {
    for (V1Protocol b : V1Protocol.values()) {
  ...
  public static class Adapter extends TypeAdapter<V1Protocol> {
    @Override
    public void write(final JsonWriter jsonWriter, final V1Protocol enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public V1Protocol read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return V1Protocol.fromValue(value);
    }
  }
}
