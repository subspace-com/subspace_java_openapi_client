...
public class V1UpdateSipTeleport {
  ...
  public V1UpdateSipTeleport() { 
  }

  public V1UpdateSipTeleport name(String name) {
  ...
  **/
  ...
  public V1UpdateSipTeleport destination(String destination) {
  ...
  **/
  ...
  public V1UpdateSipTeleport status(V1SipTeleportStatus status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1UpdateSipTeleport v1UpdateSipTeleport = (V1UpdateSipTeleport) o;
    return Objects.equals(this.name, v1UpdateSipTeleport.name) &&
        Objects.equals(this.destination, v1UpdateSipTeleport.destination) &&
        Objects.equals(this.status, v1UpdateSipTeleport.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1UpdateSipTeleport {\n");
