...
public class ApiClient {
    ...
    private String basePath = "https://api.subspace.com";
    ...
    public ApiClient() {
        ...
        authentications.put("accessCode", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://id.subspace.com/oauth/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.subspace.com
