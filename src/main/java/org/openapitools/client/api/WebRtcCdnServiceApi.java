...
public class WebRtcCdnServiceApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public WebRtcCdnServiceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public WebRtcCdnServiceApi(ApiClient apiClient) {
    ...
    /**
     * Build call for webRtcCdnServiceGetWebRtcCdn
     ...
     */
    public okhttp3.Call webRtcCdnServiceGetWebRtcCdnCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call webRtcCdnServiceGetWebRtcCdnValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = webRtcCdnServiceGetWebRtcCdnCall(_callback);
        return localVarCall;
     ...
     */
    public V1WebRtcCdnResponse webRtcCdnServiceGetWebRtcCdn() throws ApiException {
        ApiResponse<V1WebRtcCdnResponse> localVarResp = webRtcCdnServiceGetWebRtcCdnWithHttpInfo();
     ...
     * 
     * 
     * @return ApiResponse&lt;V1WebRtcCdnResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<V1WebRtcCdnResponse> webRtcCdnServiceGetWebRtcCdnWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = webRtcCdnServiceGetWebRtcCdnValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<V1WebRtcCdnResponse>(){}.getType();
     ...
     */
    public okhttp3.Call webRtcCdnServiceGetWebRtcCdnAsync(final ApiCallback<V1WebRtcCdnResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = webRtcCdnServiceGetWebRtcCdnValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<V1WebRtcCdnResponse>(){}.getType();
