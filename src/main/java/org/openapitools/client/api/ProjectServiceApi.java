...
public class ProjectServiceApi {
    ...
    /**
     * Build call for projectServiceCreate
     ...
     */
    public okhttp3.Call projectServiceCreateCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call projectServiceCreateValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = projectServiceCreateCall(_callback);
        return localVarCall;
     ...
     */
    public V1Project projectServiceCreate() throws ApiException {
        ApiResponse<V1Project> localVarResp = projectServiceCreateWithHttpInfo();
     ...
     */
    public ApiResponse<V1Project> projectServiceCreateWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = projectServiceCreateValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call projectServiceCreateAsync(final ApiCallback<V1Project> _callback) throws ApiException {

        okhttp3.Call localVarCall = projectServiceCreateValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<V1Project>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for projectServiceGet
     * @param id  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call projectServiceGetCall(String id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/project/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call projectServiceGetValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling projectServiceGet(Async)");
        }
        

        okhttp3.Call localVarCall = projectServiceGetCall(id, _callback);
        return localVarCall;
     ...
     */
    public V1Project projectServiceGet(String id) throws ApiException {
        ApiResponse<V1Project> localVarResp = projectServiceGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<V1Project> projectServiceGetWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = projectServiceGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<V1Project>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call projectServiceGetAsync(String id, final ApiCallback<V1Project> _callback) throws ApiException {

        okhttp3.Call localVarCall = projectServiceGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<V1Project>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for projectServiceList
     ...
     */
    public okhttp3.Call projectServiceListCall(String before, Long limit, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call projectServiceListValidateBeforeCall(String before, Long limit, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = projectServiceListCall(before, limit, _callback);
        return localVarCall;
     ...
     */
    public V1ListProjectsResponse projectServiceList(String before, Long limit) throws ApiException {
        ApiResponse<V1ListProjectsResponse> localVarResp = projectServiceListWithHttpInfo(before, limit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<V1ListProjectsResponse> projectServiceListWithHttpInfo(String before, Long limit) throws ApiException {
        okhttp3.Call localVarCall = projectServiceListValidateBeforeCall(before, limit, null);
     ...
     */
    public okhttp3.Call projectServiceListAsync(String before, Long limit, final ApiCallback<V1ListProjectsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = projectServiceListValidateBeforeCall(before, limit, _callback);
        Type localVarReturnType = new TypeToken<V1ListProjectsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for projectServiceUpdate
     * @param id id is the project identity (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call projectServiceUpdateCall(String id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call projectServiceUpdateValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling projectServiceUpdate(Async)");
        }
        

        okhttp3.Call localVarCall = projectServiceUpdateCall(id, _callback);
        return localVarCall;
     ...
     */
    public V1Project projectServiceUpdate(String id) throws ApiException {
        ApiResponse<V1Project> localVarResp = projectServiceUpdateWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<V1Project> projectServiceUpdateWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = projectServiceUpdateValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<V1Project>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call projectServiceUpdateAsync(String id, final ApiCallback<V1Project> _callback) throws ApiException {

        okhttp3.Call localVarCall = projectServiceUpdateValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<V1Project>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
