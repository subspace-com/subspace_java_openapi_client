...
/**
 * API tests for SipTeleportServiceApi
 */
@Ignore
public class SipTeleportServiceApiTest {

    private final SipTeleportServiceApi api = new SipTeleportServiceApi();
     ...
     */
    @Test
    public void sipTeleportServiceCreateTest() throws ApiException {
        V1CreateSipTeleport v1CreateSipTeleport = null;
        String idempotencyKey = null;
        V1SipTeleportResponse response = api.sipTeleportServiceCreate(v1CreateSipTeleport, idempotencyKey);
     ...
     */
    @Test
    public void sipTeleportServiceDeleteTest() throws ApiException {
        String id = null;
        V1SipTeleportResponse response = api.sipTeleportServiceDelete(id);
     ...
     */
    @Test
    public void sipTeleportServiceGetTest() throws ApiException {
        String id = null;
        V1SipTeleportResponse response = api.sipTeleportServiceGet(id);
     ...
     */
    @Test
    public void sipTeleportServiceListTest() throws ApiException {
        String before = null;
        Long limit = null;
        V1ListSipTeleportResponse response = api.sipTeleportServiceList(before, limit);
     ...
     */
    @Test
    public void sipTeleportServiceUpdateTest() throws ApiException {
        String id = null;
        V1UpdateSipTeleport v1UpdateSipTeleport = null;
        V1SipTeleportResponse response = api.sipTeleportServiceUpdate(id, v1UpdateSipTeleport);
