...
public class ProjectServiceApiTest {
     ...
     */
    @Test
    public void projectServiceCreateTest() throws ApiException {
        V1Project response = api.projectServiceCreate();
     ...
     */
    @Test
    public void projectServiceGetTest() throws ApiException {
        String id = null;
        V1Project response = api.projectServiceGet(id);
     ...
     */
    @Test
    public void projectServiceListTest() throws ApiException {
        String before = null;
        Long limit = null;
        V1ListProjectsResponse response = api.projectServiceList(before, limit);
     ...
     */
    @Test
    public void projectServiceUpdateTest() throws ApiException {
        String id = null;
        V1Project response = api.projectServiceUpdate(id);
